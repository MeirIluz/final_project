...
Runs on any OS with a Hailo B-Key module installed on the host machine.
...
* Docker Dependencies:  
  To run this project, you will need to add the following docker dependencies to *depends_on* section in this service on docker-compose.yml file.
  ```bash
  - kafka
  ```
